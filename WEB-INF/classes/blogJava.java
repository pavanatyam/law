...
public class blogJava extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<div class='container-fluid sticky-top'>");
            out.println("<div class='row'>");
            out.println("<div class='col-auto'><img src='logo.png' alt='logo' id='logo'></div>");
            out.println("<div class='col-7' id='title'>LEGAL AWARENESS</div>");
            out.println("<div class='col-1'><button class='btn' onclick='navigateHome()'><b>HOME</b></button></div>");
            out.println("<div class='col-1'><button class='btn'><b>ABOUT</b></button></div>");
            out.println("<div class='col-1'><button class='btn' onclick='navigateBlog()'><b>BLOG</b></button></div>");
            out.println("<div class='col-1'><button class='btn' onclick='navigateLogin()'><b>LOGIN</b></button></div>");
            out.println("</div>");
            out.println("</div>");
            ...
            out.println("<h1 style=\"color:darkblue;font-size:3em;font-weight:bold;\">Posts</h1>");
            out.println("<div class='display-comments my-3' style=\"padding: 10px;\">");
            while (rs.next()) {
                String user = rs.getString("username");
                String comment = rs.getString("express");
                out.println("<div class='comment' style=\"background: #dddcf39d;border-radius: 5px;\"><strong style=\"padding:10px\">" + user + " :</strong><br><span style=\"padding:10px\">" + comment + "</span></div>");
                out.println("<br>");
            }
            out.println("</div>");
            out.println("</div>");
